# 5 Minutes Stacks, épisode X : Rundeck! #
...
Vous êtes maintenant en possession de votre propre site Joomla!. Vous pouvez y acceder via l'url `http://ip-floatingip:4440`. Votre url complète sera présente dans la vue d'ensemble de votre stack sur la console horizon Cloudwatt.
