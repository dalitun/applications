...
A chaque nouveau déploiement de stack, un mot de passe MySQL est généré, directement dans le fichier de configuration `/var/www/html/wordpress/config-default.php`.
